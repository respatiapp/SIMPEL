<%@ Page Title="" Language="C#" MasterPageFile="~/Simple.Master" AutoEventWireup="true" CodeBehind="Chart.aspx.cs" Inherits="Respati.Web.App.Ojk.Simple.rkp.Chart" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">Pemantauan status RKP</h1>
        </div>
    </div>
