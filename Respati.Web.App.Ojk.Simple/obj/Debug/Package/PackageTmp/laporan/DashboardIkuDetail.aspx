<%@ Page Title="" Language="C#" MasterPageFile="~/Simple.Master" AutoEventWireup="true"
    CodeBehind="DashboardIkuDetail.aspx.cs" Inherits="Respati.Web.App.Ojk.Simple.laporan.DashboardIkuDetail" %>

<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    <title>Dashboard Cascading IKU - IKU yang belum diturunkan</title>
    <style>
        .btn-danger
        {
...
<asp:Content ID="Content3" ContentPlaceHolderID="FootContent" runat="server">
    <script type="text/javascript">
        ...
        $('.rgFilterBox').attr('width', headerWidth);
